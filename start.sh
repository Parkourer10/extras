...
wget https://github.com/Parkourer10/extras/raw/master/03_denos_chroot_kde.sh

# Working on this scripts...

wget https://github.com/Parkourer10/extras/raw/master/04_denos_MakeSquashfs.sh
wget https://github.com/Parkourer10/extras/raw/master/05_denos_BiosUEFI_ISO.sh
wget https://github.com/Parkourer10/extras/raw/master/denos_config.txt
